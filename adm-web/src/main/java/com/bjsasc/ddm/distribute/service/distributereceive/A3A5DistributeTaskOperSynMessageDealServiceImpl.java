...
public class A3A5DistributeTaskOperSynMessageDealServiceImpl implements MessageDealService {

	public void dealEvent(TransferEvent event) {
		synchronized (A3A5DistributeTaskOperSynMessageDealServiceImpl.class){
			try {
				...
				throw new RuntimeException("A3A5DistributeTaskOperSynMessageDealServiceImpl类中，消息反馈处理失败！", e);
			}
		}
	}
}
