...
public class A3A5ReplyDCDispatchMessageDealServiceImpl implements MessageDealService {

	public void dealEvent(TransferEvent event) {
		synchronized (A3A5ReplyDCDispatchMessageDealServiceImpl.class){
			try {
				...
				throw new RuntimeException("A3A5ReplyDCDispatchMessageDealServiceImpl类中，消息反馈处理失败！", e);
			}
		}
	}
}
