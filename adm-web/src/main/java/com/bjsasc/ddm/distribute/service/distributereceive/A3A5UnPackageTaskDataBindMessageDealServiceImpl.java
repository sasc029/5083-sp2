...
public class A3A5UnPackageTaskDataBindMessageDealServiceImpl implements MessageDealService {

	public void dealEvent(TransferEvent event) {
		synchronized (A3A5UnPackageTaskDataBindMessageDealServiceImpl.class){
			try {
				...
				throw new RuntimeException("A3A5UnPackageTaskDataBindMessageDealServiceImpl类中，消息反馈处理失败！", e);
			}
		}
	}
}
