...
<%
	...
	if (disObjList == null || disObjList.isEmpty()) {
		...
		if (persit instanceof Iterated) {
			...
			disObjVersion=it.getIterationInfo().getVersionNo()+".1";
		}
		//List<DistributeOrderObjectLink> linkList = new ArrayList<DistributeOrderObjectLink>();
		//String disObjVersion=disObjService.getCurrentDisObjectVersion(Helper.getOid(disObject.getDataClassId(), disObject.getDataInnerId()));
...
<script type="text/javascript">
	...
	function saveSubmitForm() {
		...
		var options = {
				...
				url:"<%=contextPath%>/ddm/distribute/distributeOrderHandle!reissueDistributeOrder.action",
				dataType:"json",
				type:"POST",
