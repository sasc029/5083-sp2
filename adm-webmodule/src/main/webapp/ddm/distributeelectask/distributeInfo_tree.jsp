...
<% 
	...
	String treeUrl = contextPath + "/ddm/distribute/distributeElecTaskHandle!getDistributeElecTaskTreeObject.action?oid=" + oid;
	String contentUrl = contextPath + "/ddm/distribute/distributeElecTaskHandle!getDistributeInfosByOids.action";
%>
<html >
<head>
<title><%=title%></title>
