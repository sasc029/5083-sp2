...
<%
	...
	String title = "分发信息";
	String treeUrl = contextPath + "/ddm/distributeelectask/distributeElecTaskInfo_tree.jsp?OID=" + oid;
	String contentUrl = contextPath + "/ddm/distribute/distributeInfoHandle!getAllDistributeElecTaskInfo.action?OID=" + oid;
