...
<%
	...
	String oid = listMap.get(0).get(KeyS.OID).toString();
 	...
 	//准备数据
 	String spot =  "ActiveDocument_RelatedObject_ActiveOrder";
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" scroll="no">
	...
	<th field="ACTIVECODE" width="100" tips="代号" sortable='true' >代号</th>
	<th field="ACTIVEDOCUMENTNUMBER" width="100" tips="现行文件编号" sortable='true' >现行文件编号</th>
	<th field="PAGES" width="100" tips="页数" sortable='true' >页数</th>
	<th field="ADM_COUNT" width="100" tips="份数" sortable='true' >份数</th>
	<th field="AUTHORNAME" width="100" tips="编制者" sortable='true' >编制者</th>
	<th field="AUTHORUNIT" width="100" tips="编制单位" sortable='true' >编制单位</th>
	<th field="AUTHORTIME" width="100" tips="编制日期" sortable='true' >编制日期</th>
