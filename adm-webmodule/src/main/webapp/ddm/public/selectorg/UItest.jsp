...
<table width="100%">
	...
	<form action="" id="selectConfig" ui="form">
		<table width="100%" style="margin-top: 10px;" class="pt-table">
	    	...
	    	<SPAN style='FONT-WEIGHT: bold'>公共选择组织</SPAN></td>
	    	</tr>
			<tr>
		...
		<tr align="center">
			...
			<td class='pt-label'  style="text-align:center;"	>选择组织范围</td>
		</tr>
		...
		<tr align="center">
			...
			<td class='pt-label' style="text-align:center;">非模态方式，选择回调函数</td>
		</tr>
