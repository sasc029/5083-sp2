...
<% 
	...
	String treeUrl = contextPath + "/ddm/distribute/distributeObjectHandle!getRecDesPaperObjectTree.action?oid=" + oid;
	String contentUrl = contextPath + "/ddm/distribute/distributeInfoHandle!setDistributeOrderObjectLinkOids.action";
%>
<html >
<head>
<title><%=title%></title>
