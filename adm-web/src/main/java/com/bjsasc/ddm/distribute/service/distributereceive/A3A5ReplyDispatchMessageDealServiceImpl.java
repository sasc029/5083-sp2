...
public class A3A5ReplyDispatchMessageDealServiceImpl implements MessageDealService {

	public void dealEvent(TransferEvent event) {
		synchronized (A3A5ReplyDispatchMessageDealServiceImpl.class){
			try {
				...
				throw new RuntimeException("A3A5ReplyDispatchMessageDealServiceImpl类中，消息反馈处理失败！", e);
			}
		}
	}
}
