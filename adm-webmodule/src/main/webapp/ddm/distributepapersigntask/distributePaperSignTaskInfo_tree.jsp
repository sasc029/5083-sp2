...
<% 
	...
	String treeUrl = contextPath + "/ddm/distribute/distributeObjectHandle!getDistributePaperSignTaskObjectTree.action?oid=" + oid;
	String contentUrl = contextPath + "/ddm/distribute/distributeInfoHandle!getDistributeInfosByDisOrderObjectLinkOids.action";
%>
<html >
<head>
<title><%=title%></title>
