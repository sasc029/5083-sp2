...
<body class="openWinPage">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="avidmTable">
		<tr>
			...
			<td class="e-checked-text" width="40%" style="word-break:break-all;word-wrap:break-word;">
				<%= disTask.getNumber() %>
			</td>
			<td class="left_col AvidmW150">发送人：</td>
			<td class="e-checked-text" width="40%" style="word-break:break-all;word-wrap:break-word;">
				<%= disTask.getCreateByName() %>
			</td>
		</tr>
		<tr>
			<td class="left_col AvidmW150">发送时间：</td>
			<td class="e-checked-text" width="40%" style="word-break:break-all;word-wrap:break-word;">
				<%= DateTimeUtil.getDateDisplay(disTask.getSendTime()) %>
			</td>
		...
		<tr>
			...
			<td class="e-checked-text" width="40%" style="word-break:break-all;word-wrap:break-word;">
				<%=map.get("LIFECYCLE_TEMPLATE") %>
			</td>
			<td class='left_col AvidmW150'>状态：</td>
			<td class="e-checked-text" width="40%" style="word-break:break-all;word-wrap:break-word;">
				<%=map.get("LIFECYCLE_STATE") %>
			</td>
		</tr>
			<tr>
			<td class='left_col AvidmW150'>所属发放单：</td>
			<td class="e-checked-text" width="40%" style="word-break:break-all;word-wrap:break-word;">
			<a href ="#" onclick="javascript:selectOrderProperty('<%=disTask.getOrderOid() %>')">
				<%=disTask.getOrderName() %></a>
			</td>
