...
<%
	...
	String title = "分发信息";
	String treeUrl = contextPath + "/ddm/distributeelectask/distributeInfo_tree.jsp?oid=" + oid;
	String contentUrl = contextPath + "/ddm/distribute/distributeElecTaskHandle!getDistributeForwardElecTaskInfo.action?oid=" + oid;
