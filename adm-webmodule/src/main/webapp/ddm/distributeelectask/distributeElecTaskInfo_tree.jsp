...
<% 
	...
	String treeUrl = contextPath + "/ddm/distribute/distributeObjectHandle!getDistributeElecTaskObjectTree.action?oid=" + oid;
	String contentUrl = contextPath + "/ddm/distribute/distributeInfoHandle!getDistributeInfosByElecTaskOids.action";
%>
<html >
<head>
<title><%=title%></title>
