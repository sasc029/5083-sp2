...
<%
	...
	String title = "分发信息";
	String treeUrl = contextPath + "/ddm/recdespapertask/recdesInfo_tree.jsp?oid=" + oid;
	String contentUrl = contextPath + "/ddm/distribute/distributeInfoHandle!getAllRecDesPaperInfo.action?oid=" + oid;
%>
<html>
<head>
	<title><%=title%></title>
