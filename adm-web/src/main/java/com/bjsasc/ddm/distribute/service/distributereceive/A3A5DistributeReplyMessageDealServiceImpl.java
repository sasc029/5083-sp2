...
public class A3A5DistributeReplyMessageDealServiceImpl implements MessageDealService {

	public void dealEvent(TransferEvent event) {
		synchronized (A3A5DistributeReplyMessageDealServiceImpl.class){
			try {
				...
				throw new RuntimeException("A3A5DistributeReplyMessageDealServiceImpl类中，消息反馈处理失败！", e);
			}
		}
	}
}
