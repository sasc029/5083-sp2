...
<table cellSpacing="0" cellPadding="0" height="100%" width="100%" border="0">
	<tr><td height="1%">
		...
		<table border="0" cellspacing="0" cellpadding="0" class="avidmTable">
					...
					<td class="e-checked-text">
						<input value=0  type="radio" name="disStyle" id="disStyle0" <%=disStyle_0%>  onchange="updateDisstyle('0')"/>
						正式分发&nbsp;
						<input value=1 type="radio" name="disStyle" id="disStyle1" <%=disStyle_1%>  onchange="updateDisstyle('1')"/>
						一次性分发&nbsp;&nbsp;
					</td>
					</tr>
				</table>		
