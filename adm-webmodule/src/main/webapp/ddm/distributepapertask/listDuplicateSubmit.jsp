...
<%
	...
	String spot = "ListDistributeDuplicateSubmit";
	String gridId = "distributePaperTaskGrid";
	String gridTitle = "复制完成任务";
	String toolbarId = "ddm.distributetasksubmit.list.toolbar";
...
<script type="text/javascript">
	...
	function rollbackToDuplicate(){
		...
		oids = oids.substring(0, oids.length - 1);
		ddmValidation(oids,"<%=Operate.PROMOTE%>","rollbackToDuplicateCallBack");
	}
	
	function rollbackToDuplicateCallBack(oids){
